...
const CONNECT_LINKS = [
    ...
    { name: "Resume", Icon: "https://static.vecteezy.com/system/resources/thumbnails/024/235/881/small_2x/cv-icon-resume-illustration-sign-user-data-symbol-or-logo-vector.jpg", url: "/Resume.pdf", iconBgColor: "bg-green-100" },
